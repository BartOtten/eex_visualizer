defmodule EexVisualizer.Compiler do
  @moduledoc false

  # When changing this setting, don't forget to update the docs for EExCompiler
  ...
  def compile(source, opts) when is_binary(source) and is_list(opts) do
    ...
    case EexVisualizer.Compiler.Tokenizer.tokenize(source, line, column, tokenizer_options) do
      {:ok, tokens} ->
        state = %{
  ...
  defp generate_buffer(
    ...
    # TODO: Make this an error on Elixir v2.0 since it accidentally worked previously.
    # raise EExCompiler.SyntaxError, message: message, file: state.file, line: line, column: column
  end
